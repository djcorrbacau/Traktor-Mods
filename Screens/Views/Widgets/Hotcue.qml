...
Item {
  ...
  Item {
    ...
    anchors.horizontalCenter: parent.horizontalCenter
    height:                   smallHead ? 31 : (parent.height)
    width:                    40
    clip:                     false
  ...
  Component {
	...
	// DRAW CUE POINT MARKERS IN BLUE (AS BUTTONS ON S8)
	...
	Component {
		...
		Traktor.Polygon {
			...
			color:              	colors.rgba (0, 0, 255, 255)
			border.width:       	borderWidth
			border.color:       	colors.rgba (255, 255, 255, 8)
			points: 				[ Qt.point(0 , 0), Qt.point(12, 0), Qt.point(15, 6), Qt.point(12, 12), 
									Qt.point(1 , 12), Qt.point(1 , hotcue.smallCueHeight), Qt.point(0 , hotcue.smallCueHeight) ]
			...
			Text {
				...
				color:              	colors.rgba (255, 255, 255, 255)
				text:               	hotcue.hotcueId
	...
	Component {
		...
		Traktor.Polygon {
			...
			border.width:       	borderWidth
			border.color:       	colors.rgba (255, 255, 255, 8)
			points: 				[ Qt.point(0 , 0), Qt.point(14, 0), Qt.point(19, 7), Qt.point(14, 14),
				  					Qt.point(1 , 14), Qt.point(1 , hotcue.largeCueHeight), Qt.point(0 , hotcue.largeCueHeight) ]
